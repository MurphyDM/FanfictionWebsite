...
import {Container, Dropdown, DropdownButton, Button, Row} from "react-bootstrap"
...
function WorksList(props) {
        return (
            ...
            <Container fluid>
                ...
                <DropdownButton id="dropdown-basic-button" title="Change status" style = {{marginRight: '0.5vw'}}>
                  <Dropdown.Item 
                    href="" 
                ...
                <Table 
                    headers={["id", "name", "sign_up_date", "last_sign_in_date", "status"]}    
                    items = {props.users}
