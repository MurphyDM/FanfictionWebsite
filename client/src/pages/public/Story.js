        ...
        <Container style={{ marginTop: "56px" }}>
          <Row style={{ paddingTop: "30px" }}>
            ...
            >
              <Image
                className="cover"
                src={props.story.image || BOOK_COVER_PLACEHOLDER}
                rounded
              />
            </Col>
          ...
          <Nav className={`toolbar ${props.light} justify-content-center`} style={{marginBottom: '10vh'}}>
            <Nav.Item>
              <Nav.Link
                href=""
                onClick={(e) => props.dispatch({ type: "decrementTextSize" })}
              >
            ...
            <Nav.Item>
              <Nav.Link
                eventKey=""
                onClick={(e) => props.dispatch({ type: "incrementTextSize" })}
              >
            ...
            <Nav.Item>
              <Nav.Link
                eventKey=""
                onClick={(e) => {
                  changeTheme(props.light, props.setLight);
                }}
              >
          ...
          <Row className="body" id="book">
            <Col sm={{ span: 10, offset: 1 }}>
              ...
              <pre
                ...
                style={{
                  fontSize: `${props.state.textSize}px`,
                  whiteSpace: "pre-wrap",
                }}
              >
                {props.pages &&
