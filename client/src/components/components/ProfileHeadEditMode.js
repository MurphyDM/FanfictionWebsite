...
import {Row, Col, Container, Image, InputGroup, Button, FormControl} from "react-bootstrap"
        ...
        <Container fluid fixed="top"
            ...
            <Row className="align-content-center"
                ...
                <Col className="d-block text-center"
                   ...
                   <Dropzone url= "/auth/uploadAvatar" dropZone= {()=>{ return ( <Image src={PLACEHOLDER_AVATAR_EDIT_MODE}
                 ...
                 <Button style={{background: 'none', border: 'none', color: 'gray'}}
                    ...
                    <h3 style={
                        styles.name
                         ...
                         <InputGroup className = "m-auto pt-3" 
                            style = {{width: '150px'}}
                            onSubmit={
                                e => props.submitChanges()
                            }>
                             <FormControl  
