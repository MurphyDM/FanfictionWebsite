...
function StoryForm(props) {
  ...
  const submit = (e) => {
    ...
    if (!checkFields()) {
      setErrMsg(
        "Please, fill out all the field in the form corretly (min story size: 500 symbols, min description size: 25 symbols"
      );
      return;
    }
  ...
  return (
    <div style={{ margin: "5vh 0 5vh 0" }}>
      ...
      <div className="d-flex justify-content-center">
        <Form style={{ width: "35vw" }} onSubmit={(e) => submit(e)}>
